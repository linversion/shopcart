 ...
 */
public class NewCheckbox extends View implements Checkable {
    ...
    public NewCheckbox(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.NewCheckbox);
        size = ta.getDimensionPixelSize(R.styleable.NewCheckbox_size, dp(size));
        bitmapColor = ta.getColor(R.styleable.NewCheckbox_color_background, bitmapColor);
        borderColor = ta.getColor(R.styleable.NewCheckbox_color_border, borderColor);
